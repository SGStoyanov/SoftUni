namespace TwitterNG.Web.Controllers
{
    ...
    using TwitterNG.Web.ViewModels.Login;
    using TwitterNG.Web.ViewModels.Register;
    ...
    public class AccountController : Controller
    {
        ...
        private TwitterNgContext dbContext = new TwitterNgContext();
        ...
        public ActionResult ExternalLogin(string provider, string returnUrl)
        {
            ...
            return new ChallengeResult(provider, this.Url.Action(
